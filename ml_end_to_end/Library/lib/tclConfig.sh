...
# installed.
TCL_PREFIX='D:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/end_to_end/ml/regression/krish_end_to_end/ml_end_to_end\Library\lib\tclstub86.lib'
